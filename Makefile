...
SOURCES = Rewrite.cpp ASTMutate.cpp ASTLister.cpp ASTEntry.cpp ASTEntryList.cpp Interactive.cpp Function.cpp Variable.cpp Bindings.cpp Renaming.cpp Scopes.cpp Macros.cpp TypeDBEntry.cpp AuxDB.cpp BinaryAddressMap.cpp Json.cpp Utils.cpp clang-mutate.cpp
